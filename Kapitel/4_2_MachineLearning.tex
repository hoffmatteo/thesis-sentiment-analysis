...
In order to obtain the posterior probability, we substitute $P(c=0|d_i)$ with $1 - P(c=1|d_i)$ and solve for $P(c=1|d_i)$, thus obtaining Equation \eqref{eq:logistic_sigmoid} \cite{DBLP:books/aw/TanSKK2019}:
        {\begin{equation}
